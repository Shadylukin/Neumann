...
brew install bottom dust duf procs lazygit difftastic sd
...
**Why Ollama?**
- Runs entirely offline (no data sent to cloud)
- Compatible with OpenAI API format
- Simple CLI: `ollama pull model` and `ollama run model`
...
aichat "explain this code" < file.rs
aichat --model claude-sonnet "review this PR"
```

**AIChat Features:**
- Works with OpenAI, Claude, Gemini, Ollama, Groq
...
- **[Aider](https://aider.chat/)** - AI pair programming in terminal (works with Claude, GPT, local models)
- **[Cline](https://research.aimultiple.com/agentic-cli/)** - Autonomous coding agent (open-source, model-agnostic)
- **Claude Code** - You're using it! Anthropic's official CLI (this tool)
...
# Watch tests with auto-coverage
