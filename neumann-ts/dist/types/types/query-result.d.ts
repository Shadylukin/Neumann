 ...
 */
export type QueryResultType = 'empty' | 'value' | 'count' | 'rows' | 'nodes' | 'edges' | 'paths' | 'similar' | 'ids' | 'tableList' | 'blob' | 'blobInfo' | 'chainCommitted' | 'chainTransaction' | 'unified' | 'error';
/**
 * Empty query result.
 */
 ...
 */
export type QueryResult = EmptyResult | ValueResult | CountResult | RowsResult | NodesResult | EdgesResult | PathsResult | SimilarResult | IdsResult | TableListResult | BlobResult | BlobInfoResult | ErrorResult;
/**
