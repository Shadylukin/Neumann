...
export declare enum CentralityType {
    UNSPECIFIED = 0,
    BETWEENNESS = 1,
    CLOSENESS = 2,
    EIGENVECTOR = 3
...
export interface QueryServiceClient extends grpc.Client {
    Execute(request: QueryRequest, metadata: grpc.Metadata, callback: GrpcCallback<QueryResponse>): grpc.ClientUnaryCall;
    ExecuteStream(request: QueryRequest, metadata: grpc.Metadata): grpc.ClientReadableStream<QueryResponseChunk>;
    ExecuteBatch(request: BatchQueryRequest, metadata: grpc.Metadata, callback: GrpcCallback<BatchQueryResponse>): grpc.ClientUnaryCall;
    ExecutePaginated(request: PaginatedQueryRequest, metadata: grpc.Metadata, callback: GrpcCallback<PaginatedQueryResponse>): grpc.ClientUnaryCall;
    CloseCursor(request: CloseCursorRequest, metadata: grpc.Metadata, callback: GrpcCallback<CloseCursorResponse>): grpc.ClientUnaryCall;
}
export interface BlobServiceClient extends grpc.Client {
    Upload(metadata: grpc.Metadata, callback: GrpcCallback<BlobUploadResponse>): grpc.ClientWritableStream<BlobUploadRequest>;
    Download(request: BlobDownloadRequest, metadata: grpc.Metadata): grpc.ClientReadableStream<BlobDownloadChunk>;
    Delete(request: BlobDeleteRequest, metadata: grpc.Metadata, callback: GrpcCallback<BlobDeleteResponse>): grpc.ClientUnaryCall;
    GetMetadata(request: BlobMetadataRequest, metadata: grpc.Metadata, callback: GrpcCallback<ArtifactInfo>): grpc.ClientUnaryCall;
}
export interface HealthClient extends grpc.Client {
    Check(request: HealthCheckRequest, metadata: grpc.Metadata, callback: GrpcCallback<HealthCheckResponse>): grpc.ClientUnaryCall;
}
//# sourceMappingURL=neumann.d.ts.map