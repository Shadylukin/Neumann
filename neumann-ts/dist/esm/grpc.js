 ...
 * The proto is cached after the first load.
 */
export function loadVectorProto() {
    if (_vectorProto) {
 ...
 */
export function getQueryServiceClient(proto, address, credentials, options) {
 ...
 */
export function getBlobServiceClient(proto, address, credentials, options) {
 ...
 */
export function getHealthClient(proto, address, credentials, options) {
 ...
 */
export function getPointsServiceClient(proto, address, credentials, options) {
 ...
 */
export function getCollectionsServiceClient(proto, address, credentials, options) {
