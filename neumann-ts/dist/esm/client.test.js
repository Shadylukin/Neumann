...
import { NeumannClient, convertProtoValue, convertProtoRow, convertProtoNode, convertProtoEdge, convertProtoPath, convertProtoSimilarItem, convertProtoArtifactInfo, } from './client.js';
...
import { isEmptyResult, isRowsResult, isNodesResult, isEdgesResult, isPathsResult, isSimilarResult, isErrorResult, rowToObject, nodeToObject, edgeToObject, } from './types/query-result.js';
// Mock gRPC modules
...
describe('NeumannClient', () => {
    describe('connect', () => {
        ...
        it('should throw ConnectionError when gRPC fails', async () => {
            ...
            grpc.Channel = vi.fn().mockImplementation(() => {
