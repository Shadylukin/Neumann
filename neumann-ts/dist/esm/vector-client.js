...
import { PointsClient, CollectionsClient, } from './services/vector.js';
/**
...
export class VectorClient {
    ...
    static async connect(address, options = {}) {
        try {
            ...
            const { loadVectorProto, getPointsServiceClient, getCollectionsServiceClient, } = await import('./grpc.js');
            ...
            const pointsClient = new PointsClient(grpcPointsClient, metadata);
            const collectionsClient = new CollectionsClient(grpcCollectionsClient, metadata);
