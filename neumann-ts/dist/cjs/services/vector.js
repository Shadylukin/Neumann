...
exports.CollectionsClient = exports.PointsClient = void 0;
...
class PointsClient {
    ...
    handleError(err) {
        ...
        if (code === NOT_FOUND) {
            return new errors_js_1.NotFoundError(err.details || 'Collection not found');
        }
...
class CollectionsClient {
    ...
    handleError(err) {
        ...
        if (code === ALREADY_EXISTS) {
            return new errors_js_1.InvalidArgumentError(err.details || 'Collection already exists');
        }
        if (code === UNAVAILABLE) {
            return new errors_js_1.ConnectionError(err.details || 'Service unavailable');
        }
