...
// Re-export static types for type-safe client usage
export type {
  QueryServiceClient,
  BlobServiceClient,
  HealthClient,
 ...
 */
export function loadProto(): Promise<grpc.GrpcObject> {
  if (_neumannProto) {
 ...
 * The proto is cached after the first load.
 */
export function loadVectorProto(): Promise<grpc.GrpcObject> {
  if (_vectorProto) {
  ...
  const grpcObj = grpc.loadPackageDefinition(packageDefinition);
  _vectorProto = ((grpcObj.neumann as grpc.GrpcObject).vector as grpc.GrpcObject)
 ...
 */
export function getPointsServiceClient(
  proto: grpc.GrpcObject,
  address: string,
  credentials: grpc.ChannelCredentials,
  options?: Record<string, string | number | boolean>
 ...
 */
export function getCollectionsServiceClient(
  proto: grpc.GrpcObject,
  address: string,
  credentials: grpc.ChannelCredentials,
  options?: Record<string, string | number | boolean>
